  ...
  public void draw(Graphics2D g2) {
    ...
    switch (direction) {
      case "up":
        ...
        {
          tempScreenY = screenY - gp.tileSize; // Adjusted the player's position one tile to up. Explained why I did it
                                               // at where I call attacking() in update().
          if (spriteNum == 1) {
            image = attackUp1;
          }
          if (spriteNum == 2) {
      ...
      case "left":
        ...
        if (attacking == true) // Attacking sprites
        {
          tempScreenX = screenX - gp.tileSize; // Adjusted the player's position one tile left. Explained why I did it
                                               // at where I call attacking() in update().
          if (spriteNum == 1) {
            image = attackLeft1;
          }
