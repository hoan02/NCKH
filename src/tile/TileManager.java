...
public class TileManager {
  ...
  public TileManager(GamePanel gp) {
    ...
    // READ TILE DATA FILE
    InputStream is = getClass().getClassLoader().getResourceAsStream("res/maps/tiledata.txt");
    ...
    is = getClass().getClassLoader().getResourceAsStream("res/maps/dungeon02.txt");
  ...
  public void setup(int index, String imageName, boolean collision) { // IMPROVING RENDERING // Scaling with uTool
    ...
    // With uTool I'm not using anymore like: g2.drawImage(tile[tileNum].image,
    // screenX, screenY, gp.tileSize, gp.tileSize,null);
    // I use g2.drawImage(tile[tileNum].image, screenX, screenY,null);
    try {
      tile[index] = new Tile();
      tile[index].image = ImageIO.read(getClass().getClassLoader().getResourceAsStream("res/tiles/" + imageName));
