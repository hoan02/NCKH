  ...
  public int checkObject(Entity entity, boolean player) {
    ...
    for (int i = 0; i < gp.obj[1].length; i++) {
      if (gp.obj[gp.currentMap][i] != null) {
        ...
        gp.obj[gp.currentMap][i].solidArea.x = gp.obj[gp.currentMap][i].worldX + gp.obj[gp.currentMap][i].solidArea.x; // entity's
                                                                                                                       // solid
                                                                                                                       // area
                                                                                                                       // and
                                                                                                                       // obj's
        ...
        if (entity.solidArea.intersects(gp.obj[gp.currentMap][i].solidArea)) // Checking if Entity rectangle and Object
  ...
  public int checkEntity(Entity entity, Entity[][] target) {
    ...
    for (int i = 0; i < target[1].length; i++) {
      if (target[gp.currentMap][i] != null) {
        ...
        // get the object's solid area position
        target[gp.currentMap][i].solidArea.x = target[gp.currentMap][i].worldX + target[gp.currentMap][i].solidArea.x; // entity's
                                                                                                                       // solid
                                                                                                                       // area
                                                                                                                       // and
                                                                                                                       // obj's
